                                ...
                                <div class="col-6 ">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <form action="./actualizar_estado_ticket.php?page=3" method="post">
