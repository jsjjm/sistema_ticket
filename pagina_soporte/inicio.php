...
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                ...
                <!--<img src="../images/logo multiservicios benites png.png" alt="" height="45px" >-->
            </div>
    ...
    <div class="row">
        <a class="form-select text-center " data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
            Tickets <i class="bi bi-arrow-down"></i>
        </a>
