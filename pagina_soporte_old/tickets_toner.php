...
$sql = "SELECT COUNT(*) AS num_tickets FROM tickets WHERE tipo_ticket = 'toner' ";
...
$sqlPendientes = "SELECT COUNT(*) AS num_tickets_pendientes FROM tickets WHERE estado_ticket = 'pendiente' and tipo_ticket = 'toner' ";
$resultPendientes = $conn->query($sqlPendientes);

// Consulta para calcular el número de tickets en proceso
$sqlEnProceso = "SELECT COUNT(*) AS num_tickets_en_proceso FROM tickets WHERE estado_ticket = 'en proceso' and tipo_ticket = 'toner' ";
$resultEnProceso = $conn->query($sqlEnProceso);

// Consulta para calcular el número de tickets terminados
$sqlTerminados = "SELECT COUNT(*) AS num_tickets_terminados FROM tickets WHERE estado_ticket = 'terminado' and tipo_ticket = 'toner' ";
                ...
                <div class="row px-2 pt-2">
                    ...
                    <div class="col-6 p-3 card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                            <a href="./tickets_soporte.php" class="btn btn-success">Tickets Sporte</a>
                            </div>
...
<!------ Include the above in your HEAD tag ---------->
    ...
    <?php
        ...
        $stm = $conn->prepare("SELECT id_ticket, numero_ticket, id_usuario, nombre_solicitante, tipo_ticket, detalle_ticket,id_impresora, estado_ticket, fecha_ticket FROM tickets WHERE tipo_ticket = ? ORDER BY fecha_ticket DESC");
