    ...
    <div class="row pt-4">
      <!--  <div class="col-md-4 col-sm-12 d-none d-sm-block"> -->
        ...
        <div class="col-md-8 col-sm-12">
                ...
                <div class="row px-2 pt-2 d-none">
                    ...
                    <div class="col-md-6 col-sm-12 p-3 card ">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSoporte">
                                    Crear Ticket
                                </button>
                            </div>
                            <div class="col-6">
                ...
                <div class="row">                 
                    <div class="col-6">
                            ...
                            <div class="card p-3">
                                <div class="row">
                                    <div class="col-2">
                                        <i class="bi bi-gear-fill card_size" ></i>
                                    </div>
                                    <div class="col-10">
                                        <label for="" class="card_size">Soporte</label>  
                                    </div>
                                </div>
                                <div class="row px-3">
                                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalSoporte">
                                        Crear Ticket
                                    </button>
                                </div>
                    ...
                    <div class="col-6">
                        <div class="card p-3">
                            <div class="row">
                                <div class="col-2">
                                    <i class="bi bi-printer-fill card_size" ></i>
                                </div>
                                <div class="col-10">
                                    <label for="" class="card_size">Toner</label>
                                </div>
                            </div>
                            <div class="row px-3">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalToner">
...
<!------ Include the above in your HEAD tag ---------->
    ...
    <?php
        ...
        $stm = $conn->prepare("SELECT id_ticket, numero_ticket, nombre_solicitante, tipo_ticket, detalle_ticket,id_impresora, estado_ticket, fecha_ticket FROM tickets WHERE id_usuario = ? ORDER BY fecha_ticket DESC");
